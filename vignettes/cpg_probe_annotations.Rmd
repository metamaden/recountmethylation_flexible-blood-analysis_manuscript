...
regions as well as relative to cytosine- and guanine-dense regions called CpG Islands. 
We can quickly group probes according to either their gene or CpG Island region using 
...
It is comparatively straightforward to view a probe's relation to a CpG Island 
...
alongside the CpG Island annotations, as follows:
...
annotations for CpG probes on HM450K and EPIC platforms. Additional resources, 
information, and guidance for analyzing compilations of DNAm array datasets can 
be found in the following vignettes:
